...
import it.telecomitalia.timcoupon.analytics.Analytics.TAnalyticsMethods;
import it.telecomitalia.timcoupon.service.DB;
import it.telecomitalia.timcoupon.service.DataController;
import it.telecomitalia.timcoupon.service.ServiceDelegate;
...
public class GreatBuyzApplication extends Application
{
	...
	private String allURL = "/gb/info/all.html";
	private String infoTNCURL = "/gb/info/tnc.html";
	private String infoPrivacyURL = "/gb/info/infop.html";
	private String infoCostiURL = "/gb/info/inc.html";
	...
	public String getTNCPrevURL()
	{
		return httpPrefix + getServerIP() + tncURL;
	}
	
	public String getALLTNCURL()
	{
		return httpPrefix + getServerIP() + allURL;
	}
	
	public String getINFOTNCURL()
	{
		return httpPrefix + getServerIP() + infoTNCURL;
	}
	
	public String getINFOPRIVACYURL()
	{
		return httpPrefix + getServerIP() + infoPrivacyURL;
	}
	
	public String getINFOCOSTIURL()
	{
		return httpPrefix + getServerIP() + infoCostiURL;
	}
