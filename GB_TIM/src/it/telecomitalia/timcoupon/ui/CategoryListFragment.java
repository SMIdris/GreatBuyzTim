...
public final class CategoryListFragment extends ListFragment
{
	...
	public static CategoryListFragment newInstance(String content, Activity screen, OnCategoryClick dealItemClick, FirstPageFragmentListener f)
	{
	...
	class CategoryAdapter extends ArrayAdapter<Category>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if (!TextUtils.isEmpty(imgUrl)) Picasso.with(activity).load(imgUrl).config(Bitmap.Config.RGB_565).fit().centerCrop().into(holder.imgView);
