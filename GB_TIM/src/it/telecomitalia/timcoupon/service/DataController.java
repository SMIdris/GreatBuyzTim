...
import it.telecomitalia.timcoupon.data.DealsByCategoriesDTO;
import it.telecomitalia.timcoupon.data.DealsNearMeDTO;
import it.telecomitalia.timcoupon.data.DealsOfTheDayDTO;
import it.telecomitalia.timcoupon.data.DealsYouMayLikeDTO;
import it.telecomitalia.timcoupon.data.ExclusiveDealsDTO;
import it.telecomitalia.timcoupon.data.ExploreDealsDTO;
import it.telecomitalia.timcoupon.data.MyDealsDTOOLD;
import it.telecomitalia.timcoupon.data.MyDealsDTO;
...
public class DataController
{
	...
	/*public void myDealsReceived(List<Purchase> dtos)
	{
		...
		{
			if (_myDealsDTO == null)
				_myDealsDTO = new MyDealsDTOOLD(dtos);
			else
	...
	{
		System.out.println("updateOTP new Timestamp **"+timestamp);
