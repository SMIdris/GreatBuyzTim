...
public class DealScreenDTO
{
	...
	private String _dealLocationDistrict;
	...
	public DealScreenDTO(String dealId, String merchantName, String name, String image, String details, String couponPrice, String price,
			String discount, String category, String dealVisitUrl, Date expire, boolean isExclusiveDeal, String dealLocation,String dealLocationDistrict)
	{
		_dealId = dealId;
		...
		_dealLocationDistrict = dealLocationDistrict;
	}
	...
	public String get_dealLocationDistrict() {
		return _dealLocationDistrict;
	}
