...
import it.telecomitalia.timcoupon.ui.DetailScreen;
import it.telecomitalia.timcoupon.ui.DetailScreenNew;
import it.telecomitalia.timcoupon.ui.NotificationActivity;
import it.telecomitalia.timcoupon.ui.SampleTabsStyled;
...
public final class Utils
{
	...
	/**
	 * @author suyash ---- To check that application is in foreground or
	 *         background.
	 */
	...
	public static String getTimeWithRespectToTimeZone() {
		...
		try {
			...
			timeStamp = dateFormat.format(output.getTime());
			return timeStamp;
		} catch (Exception e) {
			return timeStamp;
		}
	...
	public static void setLocationToDealTextView(TextView locationTextView, String location,String locationDistrict){
		//DataController _data = GreatBuyzApplication.getDataController();
		//String userCity = _data.getUserCity();
		if(!location.equalsIgnoreCase("")){
			/*if(userCity != null && userCity.equalsIgnoreCase(_data.getUserDefaultCity())){
				locationTextView.setVisibility(View.VISIBLE);
				locationTextView.setText("Location: "+location);
			}*/
			if(locationDistrict.equalsIgnoreCase("italia")){
				locationTextView.setVisibility(View.VISIBLE);
				locationTextView.setText("Città: " +location);
			}
			
		}
		
	}
	public static void setLocationToForCategoryDeal(TextView locationTextView, String location, String locationDistrict){
		//DataController _data = GreatBuyzApplication.getDataController();
		//String userCity = _data.getUserCity();
		//System.out.println("getUserCity "+userCity +"deal Location"+location + "  locationDistrict"+locationDistrict);
		if(!location.equalsIgnoreCase("")){
			if(locationDistrict.equalsIgnoreCase("italia")){
				locationTextView.setVisibility(View.VISIBLE);
				locationTextView.setText("Città: " +location);
