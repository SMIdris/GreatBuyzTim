...
public class CouponDetailScreen extends Activity
{
	...
	protected void onStart()
	{
		...
		GreatBuyzApplication.getApplication().getAnalyticsAgent().onPageVisit("DealDetails");
		activity = this;
	...
	private void loadNewIntent(Intent intent)
	{
		...
		/*
		 * mSpinnerText = (TextView) findViewById(R.id.spinner_text); mInappCheckBox = (CheckBox) findViewById(R.id.in_app_notification_checkbox); mNotificationSpinner = (Spinner) findViewById(R.id.notification_spinner); ArrayAdapter<String> notifadapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, spinnerValues); notifadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item); mNotificationSpinner.setAdapter(notifadapter); mInappCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		...
		try
		{
			...
			if (couponScreenDTOs == null) return;
	...
	private class DetailScreenPagerAdapter extends PagerAdapter
	{
		...
		public Object instantiateItem(View collection, int position)
		{
			...
			RelativeLayout view = (RelativeLayout) inflater.inflate(R.layout.detailed_coupon_view, null);
		...
		{
			if (couponScreenDTO == null) return;
			...
			// buy functionality ***
			btnDetailVisitDealSingle = (Button) view.findViewById(R.id.btnDetailVisitDealSingle);
			...
			Utils.setMessageToButton(btnDetailVisitDealSingle, Utils.getMessageString(AppConstants.Messages.btnCouponVisitText, R.string.btnVisitCoupon));
			btnDetailVisitDealSingle.setOnClickListener(new OnClickListener()
			{
				...
				public void onClick(View v)
				{
					...
					if (!TextUtils.isEmpty(isBuyConfirmation) && Boolean.parseBoolean(isBuyConfirmation))
					{
						...
						b.putString(AppConstants.JSONKeys.COUPON, couponScreenDTO.getCouponCode());
			...
			btnGiftAfriend = (Button) view.findViewById(R.id.btnDetailGiftDeal);
			...
			btnGiftAfriend.setVisibility(View.INVISIBLE);
			if (position == 0)
			{
				HashMap<String, String> m = new HashMap<String, String>();
	...
	private void createSettingsView()
	{
		...
		settingItems.add(new SettingItem(AppConstants.SettingItems.NOTIFICATIONS, getResources().getString(R.string.settingItemNotifications), CouponDetailScreen.this.getResources().getDrawable(R.drawable.setting_faq)));
		...
		/*
		 * isSubscribedToGCM = _data.isUserSubscribedToGCM(); emailId = _data.getEmailId();
		 */
