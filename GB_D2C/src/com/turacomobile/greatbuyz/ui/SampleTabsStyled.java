...
public class SampleTabsStyled extends FragmentActivity implements OnCategoryClick, OnDealItemClick, OnPageChangeListener
{
	...
	private void createSettingsSubView(int id)
	{
		...
		switch (id)
		{
			case AppConstants.SettingItems.PERSONAL_PROFILE:
				...
				settingSubListItems.add(new SettingItem(AppConstants.SettingItems.TNC, Utils.getMessageString(
						AppConstants.Messages.menuTerms, R.string.menuTerms), this.getResources().getDrawable(R.drawable.setting_terms)));
				break;
	...
	private void createSettingsView()
	{
		 ...
		 */
		settingItems.add(new SettingItem(AppConstants.SettingItems.ABOUT, getResources().getString(R.string.menuAbout), this.getResources()
				.getDrawable(R.drawable.setting_alert)));

		settingItems.add(new SettingItem(AppConstants.SettingItems.HELP, getResources().getString(R.string.menuHelp), this.getResources()
				.getDrawable(R.drawable.setting_help)));

		settingItems.add(new SettingItem(AppConstants.SettingItems.REFRESH, getResources().getString(R.string.menuRefresh), this
				.getResources().getDrawable(R.drawable.setting_refresh)));
	...
	public void onBack()
	{
		...
		else if (isCategoryAfterExplorDisplayed && mPager.getCurrentItem() == 4)
		{
