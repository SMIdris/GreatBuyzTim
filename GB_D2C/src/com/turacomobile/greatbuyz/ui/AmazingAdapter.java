...
public abstract class AmazingAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener
{
	...
	public final View getView(int position, View convertView, ViewGroup parent)
	{
		...
		// if (position == getCount() - 2 && automaticNextPageLoading) {
	 ...
	 */
	public abstract void onNextPageRequested(int page);
	 ...
	 */
	public abstract void bindSectionHeader(View view, int position, boolean displaySectionHeader);
