...
public interface AppConstants
{
	...
	public static final int MAXNUMBERINPUTLIMIT = 13;
	...
	public interface SharedPrefKeys
	{
		...
		public static final String termsTitle = "Terms and Conditions";
		// version control
	...
	public interface URIParts
	{
		...
		public static final String GET_IP_CHANGE_SERVERS = "/info/serverConfigInfo.json";
		...
		//public static final String GET_EXCLUSIVE_DEALS = "/exclusivedeals.json?"; // not using for idea
		public static final String GET_WELCOME_DEALS = "/welcomedeals.json?";
		
		// Gift A Friend URL 
		public static final String GIFT_A_FRIEND = "/giftafriend.json";
		
		// Payment Idea
		//public static final String PAYMENT_URL = "http://182.23.130.181/m/paymentOptions";
		public static final String PAYMENT_URL =  "/sm/purchase.json"; //sm/d2cPurchase.json
		public static final String PAYMENT_URL_D2C =  "/sm/d2cPurchase.json"; 
	...
	public interface UserMessages
	{
		...
		public static final String TITLE_HTTP_ERROR = "Unable to connect to server, please try again later";
		public static final String NETWORK_NOT_AVAILABLE = "Please check your internet connection";
	...
	{
		public static final String QUERY_SEPARATER = "\\?";
		...
		public static final String FRIEND_MSISDN = "friendMSISDN";
		public static final String MDN = "mdn";
		public static final String DEAL_CHANNEL = "dealChannel";
		public static final String SM_MODE = "smMode";
		public static final String REFERRER = "referrer";
		public static final String CHANNEL_OF_ACTIVATION = "channelOfActivation";
		public static final String LOCATIONS = "locations";
		public static final String PURCHAGE_MODE = "purchaseMode";
	...
	public interface Constants
	{
		...
		public static final String isBuyConfirmation = "isBuyConfirmation";
	}
	...
	public interface Messages
	{
		...
		public static final String topDeals = "topDeals";
		...
		public static final String locationNotAvailable = "locationNotAvailable";
	...
	public interface JSONKeys
	{
		...
		public static final String RESPONSE = "order";
